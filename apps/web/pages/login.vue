...
<template>
  <div class="flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-12">
    <div class="w-full max-w-sm">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Masuk ke Akun</h1>
      <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
        Belum punya akun?
        <NuxtLink to="/daftar" class="text-primary-600 hover:underline">Daftar gratis</NuxtLink>
      </p>
      ...
      <button
        type="button"
        class="btn-secondary flex w-full items-center justify-center gap-2 py-2.5"
